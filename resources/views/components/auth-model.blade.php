<div x-show="$store.auth.showAuthModal"
    class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md" x-cloak
    style="font-family: 'DM Sans', sans-serif;">

    {{-- Modal Card --}}
    <div @click.away="$store.auth.showAuthModal = false"
        ...
        {{-- Header --}}
        <div class="mb-10">
            <div class="mb-4 flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.3em] text-black/40">
                <span class="h-px w-4 bg-black/20"></span>
                Secure Access
            </div>
            <h2 class="text-3xl tracking-tight text-black leading-none" style="font-family: 'DM Serif Display', serif;">
        ...
        <div class="flex flex-col gap-4">
            <a href="/login"
                class="w-full bg-black text-white py-4 text-[11px] font-bold uppercase tracking-[0.2em] text-center transition hover:bg-gray-800 hover:scale-[1.02] transform duration-200">
                Proceed to Login
            </a>
            ...
            <button @click="$store.auth.showAuthModal = false"
                ...
                <span class="h-px w-0 bg-black transition-all duration-300 group-hover:w-4"></span>
                Dismiss
            </button>
        </div>
